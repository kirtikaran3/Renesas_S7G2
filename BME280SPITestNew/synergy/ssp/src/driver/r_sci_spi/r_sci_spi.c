                                                ...
                                                sspi_operation_t          tx_rx_mode)
{
    ...
    if ((NULL != p_ctrl->p_transfer_tx) &&
       ((SSPI_OPERATION_DO_TX == tx_rx_mode) || (SSPI_OPERATION_DO_TX_RX == tx_rx_mode)))
    {
    ...
    if ((NULL != p_ctrl->p_transfer_rx) &&
       ((SSPI_OPERATION_DO_RX == tx_rx_mode) || (SSPI_OPERATION_DO_TX_RX == tx_rx_mode)))
    {
        ...
        if((SSPI_OPERATION_DO_RX == tx_rx_mode) && (NULL != p_ctrl->p_transfer_tx))
        {
