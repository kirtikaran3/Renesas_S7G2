 ...
 * extends @see EXTERNAL_IRQ_API
 * This module implements the EXTERNAL_IRQ_API using the external input pins in the Interrupt Controller Unit (ICU).
 * @{
 **********************************************************************************************************************/
...
#define ICU_CODE_VERSION_MINOR   (0)
