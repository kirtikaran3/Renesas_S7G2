 ...
 * Macro definitions
 **********************************************************************************************************************/
#define SF_EXTERNAL_IRQ_API_VERSION_MAJOR (1)
#define SF_EXTERNAL_IRQ_API_VERSION_MINOR (0)

/**********************************************************************************************************************
 * Typedef definitions
 **********************************************************************************************************************/
/** Channel control block. DO NOT INITIALIZE.  Initialization occurs when SF_EXTERNAL_IRQ_Open is called */
typedef struct st_sf_external_irq_dev
{
    ...
    external_irq_api_t const  * p_api;       ///< Pointer to lower level driver function pointers.
    external_irq_ctrl_t       ctrl;          ///< Lower level driver control block.
