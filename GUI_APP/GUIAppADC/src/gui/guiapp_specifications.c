...
/*  Date (dd.mm.yyyy): 18.12.2016   Time (hh:mm): 04:01                        */
/*******************************************************************************/
...
GX_PIXELMAP_BUTTON_PROPERTIES window3_pixelbutton_properties =
{
...
GX_CONST GX_STUDIO_WIDGET window3_pixelbutton_define =
{
    "pixelbutton",
    ...
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW3_CONTROL_BLOCK, window3_pixelbutton), /* control block     */
    (void *) &window3_pixelbutton_properties /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window3_define =
{
    ...
    GX_NULL,                                 /* next widget                    */
    &window3_pixelbutton_define,             /* child widget                   */
    0,                                       /* control block                  */
