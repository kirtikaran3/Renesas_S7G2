...
#define SF_MESSAGE_API_VERSION_MAJOR (1)
#define SF_MESSAGE_API_VERSION_MINOR (1)
...
typedef struct st_sf_message_header
{
    union
    {
        ...
        struct st_event
        {
            uint32_t  class          : 8;      ///< Event class code
...
/** Messaging framework control block structure */
typedef struct st_sf_message_ctrl
{
