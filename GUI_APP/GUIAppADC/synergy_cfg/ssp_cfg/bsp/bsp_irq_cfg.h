...
#define BSP_IRQ_CFG_GLCDC_UNDERFLOW_1 (3) /* GLCDC UNDERFLOW 1: Priority 3 */
#define BSP_IRQ_CFG_GLCDC_UNDERFLOW_2 (3) /* GLCDC UNDERFLOW 2: Priority 3 */
...
#define BSP_IRQ_CFG_IIC0_RXI (3) /* IIC0 RXI: Priority 3 */
#define BSP_IRQ_CFG_IIC0_TXI (3) /* IIC0 TXI: Priority 3 */
#define BSP_IRQ_CFG_IIC0_TEI (3) /* IIC0 TEI: Priority 3 */
#define BSP_IRQ_CFG_IIC0_ERI (3) /* IIC0 ERI: Priority 3 */
...
#define BSP_IRQ_CFG_JPEG_JEDI (3) /* JPEG JEDI: Priority 3 */
#define BSP_IRQ_CFG_JPEG_JDTI (3) /* JPEG JDTI: Priority 3 */
