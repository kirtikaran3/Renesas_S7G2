...
GX_PIXELMAP_BUTTON_PROPERTIES window3_pixelmap_button_1_properties =
{
    GX_PIXELMAP_ID_5336873789_92774A6932_O,  /* normal pixelmap id             */
    0,                                       /* selected pixelmap id           */
    0                                        /* disabled pixelmap id           */
};
GX_CHECKBOX_PROPERTIES window3_checkbox_properties =
{
...
GX_CHECKBOX_PROPERTIES window3_checkbox_1_properties =
{
...
GX_CHECKBOX_PROPERTIES window3_checkbox_2_properties =
{
...
GX_CONST GX_STUDIO_WIDGET window3_checkbox_2_define =
{
    "checkbox_2",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {166, 197, 245, 220},                    /* widget size                    */
    &window3_button_define,                  /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW3_CONTROL_BLOCK, window3_checkbox_2), /* control block      */
    (void *) &window3_checkbox_2_properties  /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window3_checkbox_1_define =
{
    "checkbox_1",
    GX_TYPE_CHECKBOX,                        /* widget type                    */
    ID_GREEN,                                /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {86, 198, 165, 221},                     /* widget size                    */
    &window3_checkbox_2_define,              /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW3_CONTROL_BLOCK, window3_checkbox_1), /* control block      */
    (void *) &window3_checkbox_1_properties  /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window3_checkbox_define =
{
    "checkbox",
    GX_TYPE_CHECKBOX,                        /* widget type                    */
    ID_RED,                                  /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {14, 199, 93, 222},                      /* widget size                    */
    &window3_checkbox_1_define,              /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW3_CONTROL_BLOCK, window3_checkbox), /* control block        */
    (void *) &window3_checkbox_properties    /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window3_pixelmap_button_1_define =
{
    "pixelmap_button_1",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {13, 15, 241, 190},                      /* widget size                    */
    &window3_checkbox_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW3_CONTROL_BLOCK, window3_pixelmap_button_1), /* control block */
    (void *) &window3_pixelmap_button_1_properties /* extended properties      */
};
...
GX_CONST GX_STUDIO_WIDGET window3_define =
{
    ...
    {9, 13, 240, 305},                       /* widget size                    */
    GX_NULL,                                 /* next widget                    */
    &window3_pixelmap_button_1_define,       /* child widget                   */
    0,                                       /* control block                  */
...
GX_PIXELMAP_BUTTON_PROPERTIES window2_pixelmap_button_properties =
{
    GX_PIXELMAP_ID_IMG_20151219_130757675,   /* normal pixelmap id             */
    0,                                       /* selected pixelmap id           */
    0                                        /* disabled pixelmap id           */
};

GX_CONST GX_STUDIO_WIDGET window2_pixelmap_button_define =
{
    "pixelmap_button",
    GX_TYPE_PIXELMAP_BUTTON,                 /* widget type                    */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {16, 52, 222, 279},                      /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW2_CONTROL_BLOCK, window2_pixelmap_button), /* control block */
    (void *) &window2_pixelmap_button_properties /* extended properties        */
};
...
GX_CONST GX_STUDIO_WIDGET window2_window2_text_define =
{
    ...
    &window2_pixelmap_button_define,         /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
