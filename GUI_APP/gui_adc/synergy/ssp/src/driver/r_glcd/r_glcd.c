...
static void r_glcd_graphics_layer_set (display_input_cfg_t const * const p_input,
...
static void r_glcd_hsync_set (glcd_tcon_pin_t tcon, display_timing_t const * timing);
...
ssp_err_t R_GLCD_Open (display_ctrl_t * const p_ctrl, display_cfg_t const * const p_cfg)
{
    ...
    {
        r_glcd_graphics_layer_set(&p_cfg->input[frame], &p_cfg->layer[frame], (display_frame_layer_t)frame);
    }
                              ...
                              display_frame_layer_t               frame)
{
    ...
    /** Configure the graphics plane layers */
    r_glcd_graphics_layer_set(&p_cfg->input, &p_cfg->layer, frame);
...
static void r_glcd_sync_signal_set (display_cfg_t const * const p_cfg)
{
    ...
    r_glcd_hsync_set(tcon_hsync, &p_cfg->output.htiming);
...
static void r_glcd_hsync_set (glcd_tcon_pin_t tcon, display_timing_t const * timing)
{
    ...
    HW_GLCD_TCON_HSyncPostion_Set(0);
                                    ...
                                    display_timing_t const * const htiming, display_signal_polarity_t const polarity)
{
    ...
    HW_GLCD_TCON_HDataEnablePostion_Set(htiming->back_porch);
...
static void r_glcd_backgrpund_screen_set (display_cfg_t const * const p_cfg)
{
    ...
    HW_GLCD_BGplaneHorizontalSyncStartPositionSet((uint16_t)BG_PLANE_HSYNC_POS_MIN);
    HW_GLCD_BGplaneVerticalSyncStartPositionSet((uint16_t)BG_PLANE_VSYNC_POS_MIN);

    /** Set the start position of Background screen */
    HW_GLCD_BGplaneHorizontalStartPositionSet((uint16_t)(p_cfg->output.htiming.back_porch + BG_PLANE_HSYNC_POS_MIN));
    HW_GLCD_BGplaneVerticalStartPositionSet((uint16_t)(p_cfg->output.vtiming.back_porch + BG_PLANE_VSYNC_POS_MIN));
 ...
 **********************************************************************************************************************/
static void r_glcd_graphics_layer_blend_condition_set (display_layer_t const * const     p_layer,
 ...
 * @note    This function does not perform parameter check and it would be expected to be done in the caller function.
 **********************************************************************************************************************/
static void r_glcd_graphics_layer_set (display_input_cfg_t const * const p_input, display_layer_t const * const p_layer,
                                      display_frame_layer_t const frame)
{
    ...
    r_glcd_graphics_layer_blend_condition_set(p_layer, frame);
