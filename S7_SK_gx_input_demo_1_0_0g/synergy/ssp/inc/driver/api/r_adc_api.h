 ...
 *
 * @section ADC_API_INSTANCES Known Implementations
 * @see ADC
 *
...
#define ADC_API_VERSION_MINOR   (0)
...
{
    ADC_ADD_OFF          = 0,     ///< Addition is turned off for channels/sensors
...
{
    ADC_GROUP_A_PRIORITY_OFF             = 0,       ///< Group A ignored and does not interrupt group B
    ADC_GROUP_A_GROUP_B_WAIT_FOR_TRIGGER = 1,       ///< Group B restarts at next trigger
    ADC_GROUP_A_GROUP_B_RESTART_SCAN     = 3,       ///< Group B restarts immediately
    ADC_GROUP_A_GROUP_B_CONTINUOUS_SCAN  = 0x8001,  ///< Group B restarts immediately and scans continuously
} adc_group_a_t;
