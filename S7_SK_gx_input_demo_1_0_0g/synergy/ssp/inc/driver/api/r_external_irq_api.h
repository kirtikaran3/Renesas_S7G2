 ...
 *
 * @section EXTERNAL_IRQ_API_INSTANCES
 *
 * Known Implementation: @ref ICU
 *
 * @section EXTERNAL_IRQ_API_RELATED
 * @see KEYMATRIX_API
 *
...
#define EXTERNAL_IRQ_API_VERSION_MINOR (0)     ///< EXTERNAL IRQ API version number (Minor)
