...
VOID      _gx_display_driver_jpeg_draw(GX_DRAW_CONTEXT *context, INT xpos, INT ypos, GX_PIXELMAP *pixelmap);
...
VOID _gx_display_driver_arc_clipping_get(INT xcenter, INT ycenter, INT r, INT start_angle, INT end_angle,
