...
#define GET_REGS_PTR(x)         ((x==0) ? R_S12ADC0 : R_S12ADC1)
#define GET_DATA_ARR(x)         ((x==0) ? dreg0_ptrs : dreg1_ptrs)
#define GET_SST_ARR(x)          ((x==0) ? sreg0_ptrs : sreg1_ptrs)
#define ADC_LOCK(x)             ((x==0) ? BSP_HW_LOCK_S12ADC0 : BSP_HW_LOCK_S12ADC1)
...
#define ADC_INVALID_CH_MASK0    (0xCFC0FF80)	// Channels valid (0-6, 16-21 + sensors)
#define ADC_INVALID_CH_MASK1    (0xCFE0FF80)    // Channels valid (0-6, 16-20 + sensors)
#elif (BSP_MCU_GROUP_S3A7 == 1)  /** Channels for the S3A7 device */
#define ADC_INVALID_CH_MASK0    (0xC0000000)    // Channels valid (0-27 + sensors)
#endif
