...
GX_PROMPT_PROPERTIES w_main_txt_counter_properties =
{
...
GX_CONST GX_STUDIO_WIDGET w_main_txt_counter_define =
{
    "txt_counter",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_TXT_COUNTER,                          /* widget id                      */
    ...
    {80, 160, 159, 209},                     /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(W_MAIN_CONTROL_BLOCK, w_main_txt_counter), /* control block       */
    (void *) &w_main_txt_counter_properties  /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET w_main_define =
{
    ...
    GX_NULL,                                 /* next widget                    */
    &w_main_txt_counter_define,              /* child widget                   */
    0,                                       /* control block                  */
    (void *) &w_main_properties              /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY gxs_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = gxs_widget_table;
...
GX_STUDIO_DISPLAY_INFO gxs_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
    ...
    USHORT language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &gxs_display_table[display];
...
/* install the request theme                                                   */
    ...
    theme_ptr = gxs_display_table[display].theme_table[theme];
