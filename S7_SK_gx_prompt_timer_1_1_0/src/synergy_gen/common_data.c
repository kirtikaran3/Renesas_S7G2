...
#if (false)
#ifdef __GNUC__
uint8_t g_display_fb_foreground[1][((256 * 320) * DISPLAY_BITS_PER_PIXEL_INPUT1) >> 3] __attribute__ ((aligned(64), section(".bss")));
#else /* __ICCARM__ */
#pragma data_alignment = 64
#pragma location = ".bss"
uint8_t g_display_fb_foreground[1][((256 * 320) * DISPLAY_BITS_PER_PIXEL_INPUT1) >> 3];
#endif
#else
...
#endif
    .hsize = 256,
    .vsize = 320, .hstride = 256, .format = DISPLAY_IN_FORMAT_16BITS_ARGB4444, .line_descending_enable = false,
    .lines_repeat_enable = false, .lines_repeat_times = 0 },
...
#if (1024)
#ifdef __GNUC__
uint8_t g_sf_el_gx_jpegbuffer[1024] __attribute__ ((aligned(64), section(".bss")));
#else /* __ICCARM__ */
#pragma data_alignment = 64
#pragma location = ".bss"
uint8_t g_sf_el_gx_jpegbuffer[1024];
#endif
#endif
#endif
