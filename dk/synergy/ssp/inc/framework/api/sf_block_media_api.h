 ...
 *
 * See also FileX Interface description: @ref FrameworkFilexModule
  * @{
 **********************************************************************************************************************/
 ...
 * Macro definitions
 **********************************************************************************************************************/
#define BLOCK_MEDIA_API_VERSION_MAJOR (1)
#define BLOCK_MEDIA_API_VERSION_MINOR (1)
...
typedef struct st_sf_block_media_ctrl
{
    uint32_t    block_size;                     ///< Block size in bytes.
    void const * p_extend;                      ///< Instance or channel information.
