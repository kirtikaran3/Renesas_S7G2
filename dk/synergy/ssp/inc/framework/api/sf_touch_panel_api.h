 ...
 * Macro definitions
 **********************************************************************************************************************/
#define SF_TOUCH_PANEL_API_VERSION_MAJOR (1)
#define SF_TOUCH_PANEL_API_VERSION_MINOR (1)
...
/** Channel control block. DO NOT INITIALIZE.  Initialization occurs when SF_TOUCH_PANEL_Open is called */
typedef struct st_sf_touch_panel_ctrl
{
    ...
    void                      * p_lower_lvl_ctrl; ///< Pointer to lower level control block
