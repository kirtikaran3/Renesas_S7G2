 ...
 **********************************************************************************************************************/
/**********************************************************************************************************************
* File Name    : sf_el_fx_cfg_ref.h
* Description  : SF_EL_FX
***********************************************************************************************************************/

/*******************************************************************************************************************//**
 * @ingroup SF_EL_FX
 * @defgroup SF_EL_FX_CFG Build Time Configurations
 * @{
***********************************************************************************************************************/

#ifndef SF_EL_FX_CFG_H
#define SF_EL_FX_CFG_H
 ...
 */
#define SF_EL_FX_CFG_PARAM_CHECKING_ENABLE (BSP_CFG_PARAM_CHECKING_ENABLE)

#endif /* SF_EL_FX_CFG_H */

/*******************************************************************************************************************//**
 * @} (end defgroup SF_EL_FX_CFG)
***********************************************************************************************************************/
