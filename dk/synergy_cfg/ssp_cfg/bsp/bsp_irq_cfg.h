...
#define BSP_IRQ_CFG_ADC0_SCAN_END (5) /* ADC0 SCAN END: Priority 5 */
#define BSP_IRQ_CFG_ADC0_SCAN_END_B (5) /* ADC0 SCAN END B: Priority 5 */
...
#define BSP_IRQ_CFG_AGT0_INT (5) /* AGT0 INT: Priority 5 */
...
#define BSP_IRQ_CFG_EDMAC1_EINT (10) /* EDMAC1 EINT: Priority 10 */
#define BSP_IRQ_CFG_ELC_SOFTWARE_EVENT_0 (5) /* ELC SOFTWARE EVENT 0: Priority 5 */
#define BSP_IRQ_CFG_ELC_SOFTWARE_EVENT_1 (5) /* ELC SOFTWARE EVENT 1: Priority 5 */
...
#define BSP_IRQ_CFG_GPT0_COUNTER_OVERFLOW (6) /* GPT0 COUNTER OVERFLOW: Priority 6 */
...
#define BSP_IRQ_CFG_GPT2_COUNTER_OVERFLOW (3) /* GPT2 COUNTER OVERFLOW: Priority 3 */
...
#define BSP_IRQ_CFG_ICU_IRQ7 (3) /* ICU IRQ7: Priority 3 */
...
#define BSP_IRQ_CFG_ICU_IRQ11 (6) /* ICU IRQ11: Priority 6 */
...
#define BSP_IRQ_CFG_ICU_IRQ14 (6) /* ICU IRQ14: Priority 6 */
...
#define BSP_IRQ_CFG_RTC_ALARM (5) /* RTC ALARM: Priority 5 */
#define BSP_IRQ_CFG_RTC_PERIOD (6) /* RTC PERIOD: Priority 6 */
#define BSP_IRQ_CFG_RTC_CARRY (7) /* RTC CARRY: Priority 7 */
...
#define BSP_IRQ_CFG_SCI7_RXI (5) /* SCI7 RXI: Priority 5 */
#define BSP_IRQ_CFG_SCI7_TXI (5) /* SCI7 TXI: Priority 5 */
#define BSP_IRQ_CFG_SCI7_TEI (5) /* SCI7 TEI: Priority 5 */
#define BSP_IRQ_CFG_SCI7_ERI (5) /* SCI7 ERI: Priority 5 */
...
#define BSP_IRQ_CFG_USBFS_INT (5) /* USBFS INT: Priority 5 */
